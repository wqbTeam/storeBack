...
// 删除
var  deletes=function (client,collection,selector,callback) {
...
var updates=function (client, collection, selector, callback) {
    //                    更新条件    更新的内容    更新后的回调
...
module.exports=function (method,collections,selector,callback) {
    MongoClient.connect(urls,{useNewUrlParser:true,useUnifiedTopology:true},function (err, client) {
        ...
        if (err){
            ...
            methodType[method](client,collection,selector,callback)
            // client.close()
        }
    })
};
